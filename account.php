        ...
        <div class="container-fluid">
            ...
            <div class="row" id="main" >
                ...
                <tr>
                    ...
                    <th width="20%"></th>
                    <th width="15%">
                    	<a href="edit.php?user=<? echo $user;?>" class="btn btn-info"><i class="fa fa-list-alt"></i> แก้ไขข้อมูล </a>
                    </th>
                    <th width="15%">
                    	<a href="pass.php?user=<? echo $user;?>" class="btn btn-danger"><i class="fa fa-key"></i> เปลี่ยนรหัสผ่าน </a>
                    </th>
                </tr>
                ...
                <td>  
                <input type="text" name="fname" class="form-control input-lg" tabindex="2" value="<? echo $data['fname']?>" disabled>
                </td></tr>
                <tr><td>&nbsp;</td><td>&nbsp;</td></tr>
                <tr><td><strong> นามสกุล : </strong></td>
                <td> 
                <input type="text" name="lname" class="form-control input-lg" tabindex="3" value="<? echo $data['lname']?>" disabled> 
                </td></tr>
                <tr><td>&nbsp;</td><td>&nbsp;</td></tr>
                <tr><td><strong> อีเมล: </strong></td>
                <td>  
                <input type="email" name="email" class="form-control input-lg" tabindex="4" value="<? echo $data['email']?>" disabled>
                </td></tr>
                <tr><td>&nbsp;</td><td>&nbsp;</td></tr>
                </table>
				<? } $conn->close();?>
